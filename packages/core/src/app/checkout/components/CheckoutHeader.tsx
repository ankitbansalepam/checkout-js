...
import { getShopPayBackendUrl, ShopPayCheckoutControl } from '@bigcommerce/checkout/shop-pay-integration';
import { LoadingNotification } from '@bigcommerce/checkout/ui';
import { navigateToShopPayOrderConfirmation } from '@bigcommerce/checkout/utility';
...
export const CheckoutHeader: React.FC<CheckoutHeaderProps> = ({
    ...
    const shopPayBackendUrl = getShopPayBackendUrl();
